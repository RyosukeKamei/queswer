...
<?php else: ?>
<h2><span class='muted'>問題を開始するにはログインしてください（無料）</span></h2>
<?php endif; ?>
<?php if ($rounds): ?>
...
<?php if ($user_id): /* ユーザID制御開始 */ ?>
	...
	<?php if ($user_summaries): /* if $user_summaries 開始 */ ?>
		<table class="table table-striped">
			<thead>
				<tr>
			...
			<tbody>
				<?php foreach ($user_summaries as $user_summary): /* $user_summaries foreach 開始 */ ?>
					<tr>
				...
				<?php endforeach; /* $user_summaries foreach 終了 */ ?>
			</tbody>
		</table>
	<?php else: /* if $user_summaries else */?>
		<p>解答がありません。</p>
	<?php endif; /* if $user_summaries endif */?>
	<!-- 全体の解答サマリー -->
	...
	<?php 	
		...
		echo Form::submit('submit', '切り替える', array('class' => 'btn btn-primary'));
	?>
	<?php if ($all_summaries): /* if $all_summaries 開始 */ ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<th>項目名</th>
			...
			<tbody>
				<?php foreach ($all_summaries as $all_summary): /* foreach $all_summaries 開始 */ ?>
					<tr>
				...
				<?php endforeach; /* foreach $all_summaries 終了 */ ?>
			</tbody>
		</table>
	<?php else: /* if $all_summaries */ ?>
		<p>解答がありません。</p>
	<?php endif; /* if $all_summaries 終了 */?>
<?php endif; /* ユーザID制御終了 */ ?>
<?php Form::close(); ?>